...
/**
 * AssetGenerator handles the creation of all placeholder/procedural textures
 * used in the game. This is extracted from BootScene to improve code organization.
 */
export class AssetGenerator {
  ...
  generateAll(): void {
    ...
    this.createFloorAndWallAssets();
    this.createWorldSpecificFloorWallAssets();
    this.createEnemyAssets();
    this.createSinEnemyAssets();
    this.createProjectileAssets();
    this.createExitAndItemAssets();
    this.createItemIconAssets();
    this.createHazardAssets();
    this.createWeaponAssets();
    this.createWeaponProjectileAssets();
    this.createSpecialRoomFloorAssets();
    this.createSpecialRoomObjectAssets();
    this.createLoreObjectAssets();
    this.createGoldCoinAsset();
    this.createTavernAssets();
    this.createWorldTextures();
    this.createShopkeeperAsset();
    this.createFountainAsset();
    this.createRerollCrystalAsset();
    this.createExitPortalAsset();
    this.createTorchAsset();
    this.createCandleAsset();
  }
  ...
  private createFloorAndWallAssets(): void {
    // Floor tile
  ...
  private createWorldSpecificFloorWallAssets(): void {
    ...
    for (const worldId of getAllWorlds()) {
      ...
      const worldFloor = this.scene.make.graphics({ x: 0, y: 0 });
      ...
      const worldWall = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createEnemyAssets(): void {
    ...
    const fastEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Wings
    ...
    const tankEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Body (stone/armor)
    ...
    const rangedEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Robe
    ...
    const bossEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Body
  ...
  private createSinEnemyAssets(): void {
    // Pride enemy (tall golden figure with crown)
    const prideEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Tall body
    ...
    const greedEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Hunched body
    ...
    const wrathEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Muscular body
    ...
    const slothEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Wide blob body
    ...
    const envyEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Shadowy body
    ...
    const gluttonyEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Large round body
    ...
    const lustEnemyGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Glowing aura
  ...
  private createProjectileAssets(): void {
    // Enemy projectile (red circle)
    const enemyProjGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createExitAndItemAssets(): void {
    // Exit/stairs tile (descending staircase)
    const exitGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createItemIconAssets(): void {
    // Armor icon (chestplate shape)
    const armorIconGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const accessoryIconGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const potionIconGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Bottle body
    ...
    // Door (brown/red bar)
    const doorGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createHazardAssets(): void {
    ...
    const spikeActiveGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const arrowShooterGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createWeaponAssets(): void {
    ...
    const wandGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    // Sword (silver blade)
    const swordGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const bowGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const staffGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const daggersGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createWeaponProjectileAssets(): void {
    // Wand projectile (yellow magic bolt) - reusing existing 'projectile'
    const wandProjGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const slashGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const bowArrowGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const orbGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    // Dagger projectile
    const daggerProjGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const weaponDropGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createSpecialRoomFloorAssets(): void {
    // Treasure room floor (golden/yellow tint)
    const treasureFloorGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const trapFloorGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const shrineFloorGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const challengeFloorGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createSpecialRoomObjectAssets(): void {
    // Treasure chest (closed)
    const chestGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Chest body
    ...
    // Treasure chest (open)
    const chestOpenGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Chest body
    ...
    const shrineGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Pedestal
    ...
    const skullMarkerGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Skull
  ...
  private createLoreObjectAssets(): void {
    // Stone Tablet (carved stone slab with runes)
    const tabletGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Stone base
    ...
    const scratchGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Faint scratch marks
    ...
    const whisperGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Ethereal glow (outer)
  ...
  private createGoldCoinAsset(): void {
    const goldCoinGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Coin body
  ...
  private createTavernAssets(): void {
    // Shrine floor (sacred stone tiles)
    const tavernFloorGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    ...
    const tavernWallGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createShopkeeperAsset(): void {
    // Guardian Angel (shopkeeper)
    const shopkeeperGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Wings (behind body)
  ...
  private createFountainAsset(): void {
    // Heal fountain (stone fountain with blue water)
    const fountainGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Base
  ...
  private createRerollCrystalAsset(): void {
    // Reroll crystal (purple floating crystal)
    const rerollCrystalGraphics = this.scene.make.graphics({ x: 0, y: 0 });
  ...
  private createExitPortalAsset(): void {
    // Exit portal (green swirling vortex)
    const exitPortalGraphics = this.scene.make.graphics({ x: 0, y: 0 });
    // Outer glow
  ...
  private createCandleAsset(): void {
    // Wall candle/sconce (for dungeon atmosphere)
    const candleGraphics = this.scene.make.graphics({ x: 0, y: 0 });
